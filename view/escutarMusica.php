...
$('.typeahead__cancel-button').trigger('click');
    ...
    <script>
        function mostarCriarPlaylist(){
            ...
            document.getElementById("botaoAddPlaylist").innerHTML='<button type="button" class="btn btn-primary">Criar e adcionar</button>';
        }
        function mostarSelecionarPlaylist(){
            document.getElementById("criarPlaylist").style.display="none";
            document.getElementById("selecionarPlaylist").style.display="block";
            document.getElementById("botaoAddPlaylist").innerHTML='<button type="button" class="btn btn-primary">Adcionar</button>';
        }
    </script>
...
<body>
         ...
         <div class="right-div">
           ...
           if($_SESSION['tipo']==1){
            ...
            if(isset($_GET['m'])){
                ...
                $dataHoje = date("Y-m-d");
                $musica= new Musica();
                $existe=$musica->verificarHash($_GET['m']);
                if($existe>=1){
                    $musica->upLink($_GET['m'],$dataHoje);
                }
                else{
                    echo '<script>window.location.href="erros/erro_link.html";</script>'; 
                }
            }
            else{
                echo '<script>window.location.href="erros/erro_401.html";</script>'; 
    ...
    <div class="content-wrapper" style="padding-bottom: 0px">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Escutar música</h4>
    ...
    <a id="demo-success"  style="display:none">Success notification</a>
                             ...
                             <div class="modal fade" id="ModalCompartilhar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
								...
								<input class="form-control" id="file-input" name="imagemPlaylist" type="file"  style="display:none" required >
                                          ...
                                          <input type="hidden" name="paginaMusica" value="<?php echo $_GET['m']; ?>">
                                        </div>
 ...
 <div class="panel panel-default" >
                        ...
                        <?php
                            ...
                            $musicaSelecionada= $musica->listarMusica($_GET['m']);
                            $musicaSelecionadaArray= $musica->listarMusica($_GET['m']);
                            @$idUsuario=$_SESSION['id_usuario'];
                            $playlists=new Playlist();
                            $i=0;
                            foreach($musicaSelecionada as $m){
                                $idMusica=$m['idMusica'];
            ...
            echo '<table>
                    ...
                    <tr>
                        <td>
                            <span style="margin-left:10px;font-family:Times, Times New Roman, serif;color:#828282">Cantor: '.$artista.'</span>
                        </td>
                    </tr>
                </table>
            ...
            <?php
                            ...
                            $musicaRecomendadas= $musica->listarRecomendados($idMusica);
                            $musicaRecomendadasArray= $musica->listarRecomendados($idMusica);
                          
                            foreach($musicaRecomendadas as $m){
                                $idMusica=$m['idMusica'];
                                    $nomeMusica=$m['nomeMusica'];
                                    $imgAlbum=$m['imgAlbum'];
                                    $diretorio=str_replace("view/","",$m['diretorio']);
     ...
     <script>
        ...
        for (i = 0; i <=5; i++){
         ...
         <?php
            $i=0;
           foreach ($musicaSelecionadaArray as $m){
                    $idMusica=$m['idMusica'];
                    $nomeMusica=$m['nomeMusica'];
                    $imgAlbum=$m['imgAlbum'];
                    $diretorio=str_replace("view/","",$m['diretorio']);
        ...
        ';
           ...
           foreach ($musicaRecomendadasArray as $m){
                    $idMusica=$m['idMusica'];
                    $nomeMusica=$m['nomeMusica'];
                    $imgAlbum=$m['imgAlbum'];
                    $diretorio=str_replace("view/","",$m['diretorio']);
