...
wave::-webkit-scrollbar-thumb {
  ...
  <link rel="stylesheet" href="view/js/jquery.typeahead.css">
  <script src="http://code.jquery.com/jquery-2.1.0.min.js"></script>
   <script src="view/js/jquery.typeahead.js"></script>
   <script>
      function  nomeMusica(m,idm){
          ...
          document.getElementById("thumb-output").innerHTML='<img src="view/imagens_sistema/no-image.jpg" width="350px" height="250px" onclick="escolherImagem()" style="cursor:pointer">';
...
<body >
    <div class="navbar navbar-inverse set-radius-zero" >
        <div class="container">
            ...
            <div class="right-div">
               ...
               include "view/bemVindoIndex.php";
            }
            
        }
        else{
            echo '<a href="view/login.php" class="btn btn-primary pull-right">Login/Cadastro</a>';
        }
                ?>
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            <li class='menu-top-active'><a href="index.php" >Home</a></li>
                           
                            
                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown">Músicas <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="view/minhasplaylists.php">Minhas playlist's</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="view/musicas.php">Procurar músicas</a></li>
                                </ul>
                            </li>
             ...
             <div class="row">
                ...
                ?>
                 <div class="col-md-4 col-sm-3 col-xs-6"  >
                      <div class="alert alert-info back-widget-set text-center" style="background-color:#fff">
              ...
              <div class="col-md-4 col-sm-3 col-xs-6">
                      <div class="alert alert-success back-widget-set text-center" style="background-color:#fff">
               ...
               <div class="col-md-4 col-sm-3 col-xs-6">
                      <div class="alert alert-danger back-widget-set text-center" style="background-color:#fff">
 ...
 <div class="panel panel-default" >
                      ...
                      <!--<div class="col-md-4 col-sm-3 col-xs-6">
                      <div class="alert-info back-widget-set" style="border:1px solid #ccc">
                           <img src="imagens_sistema/imagens_albuns/exemplo.jpg" width="100px">
                           <button id="playPause" class="btn" style="    color: #333;
    background-color: #fff;
    border-color: #ccc;margin-left:10px;margin-bottom:55px"><i class='fa fa-play' aria-hidden='true'></i></button><button id="playPause" class="btn btn-xs" style="    color: #333;
    background-color: #fff;
    border-color: #ccc;margin-left:10px;margin-bottom:55px"><i class="fas fa-plus"></i></button>
   
    <div id="wave" style="margin-left:10px;margin-bottom:55px">
    <p id="progress"></p>
</div>
                                          ...
                                          <h5 style="font-size:15px"><b>CRIAR UMA PLAYLIST</b></h5>
                                           <div class="form-group">
                                            <label style="font-weight: normal">Imagem da playlist</label>
                                            	...
                                            	<center><div id="thumb-output" ><img src="view/imagens_sistema/no-image.jpg" width="350px" height="250px" onclick="escolherImagem()" style="cursor:pointer"></div><br><span id="selectImg">Selecione uma imagem</span></center>
    ...
    <div class="col-md-12 col-sm-3 col-xs-6">
                    ...
                    <tr>
                        <td rowspan="3" >
                           <div style="position:relative; top:0px; left:0px;" id="divGeral" onmouseover="mostarImg(\'imgPlay'.$i.'\')" onmouseout="ocultaImg(\'imgPlay'.$i.'\')">
                              <img src="view/imagens_sistema/imagens_albuns/'.$imgAlbum.'" width="100px" class="h"  >
                               <div style="position:absolute; top:20px; left:15px;display:none;cursor:pointer" id="imgPlay'.$i.'">
                                   <img src="view/imagens_sistema/play.svg" width="70px" id="playPause'.$i.'" onclick="musica('.$i.',\''.$diretorio.'\',\'view/imagens_sistema/imagens_albuns/'.$imgAlbum.'\',\''.$nomeMusica.'\',\''.$albumAno.'\',\''.$artista.'\')">
                               </div>
                            </div>
     ...
     <!-- CONTENT-WRAPPER SECTION END-->
            ...
            <div class="row">
                <div class="col-md-4">
                   <table>
                           ...
                           <div style='position:relative; top:0px; left:0px;' >
                              <span id="imgMusica"></span>
                               <div style='position:absolute; top:20px; left:15px;display:none;cursor:pointer' >
                                   <img src="view/imagens_sistema/play.svg" width="70px" >
                               </div>
                            </div>
                            
                        </td>
                        <td >
                            <span style="float:left; margin-left:5px"><b style="font-size:16px;color:black;text-transform:uppercase"><span id="nomeMusicas"></span></b></span>
                    ...
                    <tr>
                        <td>
                            <b ><span style="font-family:Times, Times New Roman, serif;color:black; float:left; margin-left:5px">Álbum: <span id="albMusicas"></span></span></b>
                        </td>
                    </tr>
                    <tr>
                        <td>
                             <b ><span style="font-family:Times, Times New Roman, serif;color:black; float:left; margin-left:5px">Cantor: <span id="cantMusicas"></span></span></b>
                        </td>
                    </tr>
      ...
      <input type="range" class="form-control" min="0" max="1" step="0.1" value="0.2" onmousemove="MudarVolume(this.value)" id="volumeInput" style="height:39px">
                   ...
                   <center>
                    <button type="button" class="btn btn-default btn-sm" onclick="anteMusica()"><i class="fas fa-step-backward" style="font-size:25px"></i></button>  <span id="botaoPlayPause"><a href="#" class="btn btn-default btn-sm"><i class="fas fa-pause-circle" style="font-size:25px"></i></a></span> <button type="button" class="btn btn-default btn-sm" onclick="proxMusica()"> <i class="fas fa-step-forward" style="font-size:25px"></i></button> <span id="barraMusica"><input type="range" value="0" disabled id="barraStatusMusica"></span><span style="float:left;color:white" id="teste">00:00:00</span> <span style="float:right;color:white" id="teste1">00:00:00</span></center>
                    </div>
        ...
        <script src="view/js/wavesurfer.min.js"></script>
  <script>
        ...
        myArray['.$i.'][3]="'.$artista.'";
        myArray['.$i.'][4]="view/imagens_sistema/imagens_albuns/'.$imgAlbum.'";
...
function musica (m,mus,img,nome,amb,cant){
    ...
    var musicaFiltrada= mus.replace("%20/g"," ");
            wavesurfer.load(musicaFiltrada);
            var volumeAtual=0.2;
    ...
    <!-- JAVASCRIPT FILES PLACED AT THE BOTTOM TO REDUCE THE LOADING TIME  -->
      <script>
        ...
        var data = [
            ...
            "id": "'.$idPlaylist.'",
            "name": "'.$nomePlaylist.'",
            "email": "<img src=\'view/imagens_sistema/imagens_playlist/'.$imagemPlaylist.'\' height=\'50px\' width=\'50px\'><b> '.$nomePlaylist.'</b> '.$qtdMusicas.' '.$msgMusicas.'"
        },';
            }
            ?>
           ];
...
jQuery( document ).ready(function( $ ) {
  ...
  <script src="view/js/pace.min.js"></script>
   <link href="view/css/jquery.notify.css" type="text/css" rel="stylesheet" />
    
    <!--jQuery-->
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>

<script type="text/javascript" src="view/js/jquery.notify.min.js"></script>
    <script>
...
jQuery( document ).ready(function( $ ) {
		   ...
		   $('#demo-success').on('click', function(){
                notify({
                    ...
                    icon: '<img src="view/imagens_sistema/checkmark.png" />',
   ...
   $('#demo-error').on('click', function(){
                notify({
                    ...
                    icon: '<img src="view/imagens_sistema/error.png" />',
